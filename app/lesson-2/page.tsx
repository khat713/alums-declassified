        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div>
            <div className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🏛 Academic Support</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">💰 Financial Resources</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🧠 Health and Wellbeing</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🚪 How to Actually Walk Into an Office for the First Time</h4>
              ...
              <div className="mt-6">
                <h4 className="font-bold text-[#1b2537] mb-3">🗺 Campus Resource Categories — Visual Overview</h4>
                ...
                <p className="text-[0.82rem] text-[#8d9db5] mt-2">The three resource categories every first-gen student should know before day one.</p>
              </div>
            </div>
          ...
          <div>
            <div className="sticky top-[74px]">
              ...
              <div className="bg-[#fef3e2] rounded-[10px] p-6 border border-[#fcd69a]">
                ...
                <p className="text-[0.85rem] text-[#8d9db5] mb-3">Head back to Module 2 to complete the activity and assessment.</p>
