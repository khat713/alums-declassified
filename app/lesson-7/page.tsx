        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div>
            <div className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🎭 Imposter Syndrome</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🔀 Code-Switching</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🏠 Homesickness</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🧠 When Stress Becomes Something More</h4>
            ...
            <div className="flex justify-between items-start py-5 border-t border-[#dde2eb] mt-2">
              ...
              <div className="text-right">
                <p className="text-[0.75rem] uppercase tracking-[0.08em] text-[#8d9db5] font-semibold mb-1">All Modules →</p>
          ...
          <div>
            <div className="sticky top-[74px]">
              ...
              <div className="bg-[#fef3e2] rounded-[10px] p-6 mb-4 border border-[#fcd69a]">
                ...
                <p className="text-[0.85rem] text-[#8d9db5] mb-3">Head back to Module 7 to complete the activity and assessment.</p>
