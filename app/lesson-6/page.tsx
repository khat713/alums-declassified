        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div>
            <div className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">📄 Resume Basics: What to Include</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">💼 Formatting Rules</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🔗 LinkedIn Basics</h4>
              <ul className="ml-5 mb-4 space-y-2 text-[0.92rem]">
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🤝 Networking Without Feeling Awkward</h4>
              ...
              <div className="mt-6">
                <h4 className="font-bold text-[#1b2537] mb-3">📋 Sample First-Year Resume — Annotated</h4>
                ...
                <p className="text-[0.82rem] text-[#8d9db5] mt-2">A fictional student resume showing how to present part-time work, volunteering, and school activities professionally.</p>
              </div>
            </div>
          ...
          <div>
            <div className="sticky top-[74px]">
              ...
              <div className="bg-[#fef3e2] rounded-[10px] p-6 border border-[#fcd69a]">
                ...
                <p className="text-[0.85rem] text-[#8d9db5] mb-3">Head back to Module 6 to complete the activity and assessment.</p>
