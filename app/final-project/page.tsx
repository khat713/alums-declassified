      ...
      <section className="bg-[#1b2537] text-white py-[38px] pb-8 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-4 text-[0.88rem]">
            <span className="bg-white/10 rounded-full px-4 py-[6px] flex items-center gap-2"><Clock size={14} /><strong>~3–5 hours</strong></span>
            <span className="bg-white/10 rounded-full px-4 py-[6px] flex items-center gap-2"><FileText size={14} /><strong>Assignment 9: College Readiness Portfolio</strong></span>
            <span className="bg-white/10 rounded-full px-4 py-[6px] flex items-center gap-2"><Award size={14} /><strong>150 points</strong></span>
          </div>
        </div>
      </section>
