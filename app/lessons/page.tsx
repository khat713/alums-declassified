...
const lessons = [
  ...
  { emoji: "💼", week: "Week 6", title: "Career Preparation", desc: "Resume basics, LinkedIn setup, elevator pitches, networking without the awkwardness, and using your campus career center.", lessonHref: "/lesson-6", moduleHref: "/module-6" },
  { emoji: "🧠", week: "Week 7", title: "Emotional Resilience", desc: "Imposter syndrome, code-switching, homesickness, the difference between stress and crisis, and when to reach out for support.", lessonHref: "/lesson-7", moduleHref: "/module-7" },
];
