    ...
    <main>
      ...
      <section className="module-header border-b py-9 pb-7">
        <div className="container mx-auto px-4">
          ...
          <p className="text-[#5a6a82] dark:text-[#94a3b8] text-[0.97rem] m-0 max-w-[600px]">
            Each module contains the full lesson, activity, and assessment. Click Go to Module to begin. Work through each week in order before your first semester starts.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 my-12">
        <div className="bg-white dark:bg-[#1e293b] rounded-[10px] p-7 mb-5 border border-[#dde2eb] dark:border-[#334155] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
          ...
          <p>
            Each module contains the full lesson, activity, and assessment. Click &ldquo;Go to Module&rdquo; to begin. Work through each week in order before your first semester starts.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-[#1e293b] rounded-[10px] p-7 mt-8 border border-[#dde2eb] dark:border-[#334155] shadow-[0_1px_2px_rgba(27,37,55,0.06)] text-center">
          ...
          <p className="max-w-[560px] mx-auto mb-5 text-[0.93rem]">
            Each module includes the lesson, a hands-on activity, and a graded assessment. Work through all seven in order.
          </p>
          <Link
            href="/start-here"
