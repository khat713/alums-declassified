          ...
          <div>
            ...
            <div id="lesson" className="content-block p-7 mb-5" style={{ borderLeft: '3px solid #0d7c7e' }}>
              ...
              <Infographic title="Free Money vs. Borrowed Money" filename="Infographic - How to Read Your Award Letter.png" active={true} />
                  ...
                  "More students leave college over money than over grades, and most of the time it is not because they are bad with money but because nobody explained how college money actually works. The vocabulary alone is a wall: award letters, disbursement, subsidized, work-study, cost of attendance. You cannot manage money you do not understand, so this lesson breaks all of it down.",
                  ...
                  "None of this requires being naturally good with money. You just need to read your award letter carefully, know which money is free and which is borrowed, and write out a budget before school starts.",
                ]}
