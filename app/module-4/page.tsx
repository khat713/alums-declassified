          ...
          <div>
            ...
            <div id="lesson" className="content-block p-7 mb-5" style={{ borderLeft: '3px solid #0d7c7e' }}>
              ...
              <Infographic title="The Adult Skills Checklist" filename="Infographic - The Adulting Cheat Sheet.png" active={true} />
                  ...
                  "None of these skills are hard, but they can feel that way because they are usually learned at home, slowly, from someone who already knew. If you did not get that, you are picking them all up at once under pressure. You do not need to master all of it right now. Just figure out what you already know and make a plan for the rest before school starts.",
                ]}
              headings={[{ beforeIndex: 1, text: "Groceries and Cooking" }, { beforeIndex: 3, text: "Laundry" }, { beforeIndex: 4, text: "Health Insurance" }, { beforeIndex: 5, text: "Leases" }]}
            />
            </div>
            </FadeIn>
            ...
            <div id="model" className="content-block p-7 mb-5">
              ...
              <DocumentDownload title="Module 4 Worked Example" description="Read through this before you write your own." filename="Module_4_Model_Responses.docx" type="model" active={true} />
            </div>
            </FadeIn>
