...
export default function HomePage() {
  return (
    <main>
      {/* HERO */}
      <section
        className="bg-white border-b border-[#dde2eb] text-center py-16 px-4"
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <h1
            className="text-[2.8rem] font-bold leading-[1.15] tracking-[-0.025em] text-[#1b2537] mb-4 mx-auto"
          ...
          <p
            className="text-[#5a6a82] text-[1.1rem] leading-[1.7] mx-auto mb-8"
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <Link
              href="/module-1"
              className="bg-transparent text-[#1b2537] border-[1.5px] border-[#1b2537] no-underline py-[13px] px-[30px] text-[0.95rem] rounded-[5px] font-semibold inline-block hover:bg-[#1b2537] hover:text-white transition-all"
            >
              Jump to Module 1 →
            </Link>
          </div>
      ...
      <div className="container mx-auto px-4 my-12">
        ...
        <div className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-5">
            {[
              ...
              <div
                key={i}
                className="border border-[#dde2eb] rounded-[10px] p-5 h-full"
              >
                <p className="text-[1.4rem] mb-[0.4rem]">{item.emoji}</p>
                <strong className="text-[#1b2537]">{item.title}</strong>
                <p className="text-[0.88rem] text-[#5a6a82] mt-[0.3rem] mb-0">
                  {item.desc}
                </p>
              </div>
            ))}
          ...
          <div className="flex gap-8 flex-wrap mt-5">
            {[
              ...
              <div key={i} className="text-center">
                ...
                <p className="text-[0.82rem] text-[#5a6a82] m-0">
                  {stat.label}
                </p>
              </div>
            ))}
        ...
        <div className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
          ...
          <div className="bg-[#f2f4f7] border-[1.5px] border-dashed border-[#dde2eb] rounded-[5px] p-[1.4rem_1.5rem] text-[#5a6a82] text-[0.92rem] leading-relaxed text-center">
