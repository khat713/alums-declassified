        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div>
            <div className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">🗂 The Syllabus Is a Contract</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">📬 Office Hours Are Not a Trap</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">✉️ How to Email a Professor</h4>
              ...
              <div className="bg-[#f2f4f7] rounded-[6px] p-4 mb-4 text-[0.88rem]">
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">⚖️ Academic Integrity: What It Actually Means</h4>
              ...
              <h4 className="font-bold text-[#1b2537] mt-6 mb-2">📅 Attendance: The Invisible Grade</h4>
              ...
              <div className="mt-6">
                <h4 className="font-bold text-[#1b2537] mb-3">🖼 5 Unwritten Rules of College — Visual Guide</h4>
                <img src="/images/module1-infographic.png" alt="5 Unwritten Rules of College infographic" className="w-full rounded-[8px] mt-2" />
                <p className="text-[0.82rem] text-[#8d9db5] mt-2">The five rules covered in this lesson, summarized visually.</p>
              </div>
            </div>
            ...
            <div className="flex justify-between items-start py-5 border-t border-[#dde2eb] mt-2">
              <div>
                <p className="text-[0.75rem] uppercase tracking-[0.08em] text-[#8d9db5] font-semibold mb-1">← Back to Module</p>
          ...
          <div>
            <div className="sticky top-[74px]">
              ...
              <div className="bg-[#fef3e2] rounded-[10px] p-6 border border-[#fcd69a]">
                ...
                <p className="text-[0.85rem] text-[#8d9db5] mb-3">Head back to Module 1 to complete the activity and assessment.</p>
