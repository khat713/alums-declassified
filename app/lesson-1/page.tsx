        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div>
            <div className="bg-white dark:bg-[#1e293b] rounded-[10px] p-7 mb-5 border border-[#dde2eb] dark:border-[#334155] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h4 className="font-bold text-[#1b2537] dark:text-[#e2e8f0] mt-6 mb-2">How to Email a Professor</h4>
              ...
              <h4 className="font-bold text-[#1b2537] dark:text-[#e2e8f0] mt-6 mb-2">Academic Integrity: What It Actually Means</h4>
