    ...
    <main>
      <div className="bg-white border-b border-[#dde2eb] py-[10px] text-[0.82rem]">
        <div className="container mx-auto px-4">
          ...
          <Link href="/modules" className="text-[#5a6a82] hover:text-[#0d7c7e] hover:underline">Modules</Link>
          <span className="text-[#8d9db5] mx-[6px]">/</span>
          <span className="text-[#1b2537] font-medium">Module 2: Campus Resources</span>
        </div>
      </div>
      ...
      <section className="bg-white border-b border-[#dde2eb] py-9 pb-7">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-[clamp(1.5rem,3vw,1.95rem)] font-bold text-[#1b2537] mb-[0.4rem] tracking-[-0.025em] leading-[1.2]" style={{ fontFamily: "var(--font-display)" }}>Campus Resources</h1>
          <p className="text-[#5a6a82] text-[0.97rem] max-w-[600px] m-0">The resources exist. Most first-gen students never use them — not because they don&apos;t qualify, but because nobody told them they were there.</p>
          <div className="flex flex-wrap gap-4 mt-4 pt-4 border-t border-[#edf0f4]">
            <span className="flex items-center gap-[5px] text-[0.82rem] text-[#5a6a82]">⏱ <strong className="text-[#1b2537]">~45 minutes</strong></span>
            <span className="flex items-center gap-[5px] text-[0.82rem] text-[#5a6a82]">🗺 <strong className="text-[#1b2537]">Assessment:</strong> Campus Resource Map</span>
            <span className="flex items-center gap-[5px] text-[0.82rem] text-[#5a6a82]">🏆 <strong className="text-[#1b2537]">75 points</strong></span>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          <div>
            <div id="objectives" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>By the End of This Module, You Will Be Able To:</h2>
            ...
            <div id="lesson" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>Module 2 Lesson</h2>
              ...
              <div className="mt-6">
                <h4 className="font-bold text-[#1b2537] mb-3">🗺 Campus Resource Map — Visual Overview</h4>
            ...
            <div id="activity" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>Activity: Write Your First Professional Email</h2>
            ...
            <div id="assessment" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>Campus Resource Map — Assignment 2 (75 pts)</h2>
            ...
            <div id="model" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>Example Resource Map — See What Proficient Looks Like</h2>
              <p><strong>Example Resource Map — Jordan, First-Year Student at Riverside Community College:</strong></p>
              <div className="overflow-x-auto mt-2">
                <table className="w-full border-collapse text-[0.875rem]">
                  <thead><tr>{["Resource","Location","Contact","When I Would Use It"].map(h=><th key={h} className="bg-[#f2f4f7] text-[#5a6a82] px-[14px] py-[10px] text-left font-semibold text-[0.75rem] uppercase tracking-[0.07em] border-b-2 border-[#dde2eb]">{h}</th>)}</tr></thead>
                  <tbody>
                    {[
                      ...
                      <tr key={i} className="hover:bg-[#fafbfd]">
                        {row.map((cell,j)=><td key={j} className="px-[14px] py-[11px] border-b border-[#edf0f4] align-top">{cell}</td>)}
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div id="tools" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>Technological Tools</h2>
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-[0.875rem]">
                  <thead><tr>{["Tool","Purpose","Privacy Policy","Cost"].map(h=><th key={h} className="bg-[#f2f4f7] text-[#5a6a82] px-[14px] py-[10px] text-left font-semibold text-[0.75rem] uppercase tracking-[0.07em] border-b-2 border-[#dde2eb]">{h}</th>)}</tr></thead>
                  <tbody>
                    <tr className="hover:bg-[#fafbfd]"><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">Google Forms</td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">Submit the Campus Resource Map</td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]"><a href="https://policies.google.com/privacy" target="_blank" rel="noopener" className="text-[#0d7c7e] hover:underline">View</a></td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">Free</td></tr>
                    <tr className="hover:bg-[#fafbfd]"><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">Canva</td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">Module infographic (campus resource categories)</td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]"><a href="https://www.canva.com/policies/privacy-policy/" target="_blank" rel="noopener" className="text-[#0d7c7e] hover:underline">View</a></td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">Free</td></tr>
                  </tbody>
                </table>
              </div>
            </div>

            <div className="bg-white border border-[#dde2eb] rounded-[10px] py-5 px-7 shadow-[0_1px_2px_rgba(27,37,55,0.06)] flex justify-between items-center flex-wrap gap-4 mt-2">
              <div><p className="text-[0.72rem] uppercase tracking-[0.08em] text-[#8d9db5] font-bold mb-[0.2rem]">← Previous</p><p className="text-[0.93rem] font-semibold m-0"><Link href="/module-1" className="text-[#1b2537] hover:text-[#0d7c7e] hover:underline">Module 1: College Expectations</Link></p></div>
              <div className="text-right"><p className="text-[0.72rem] uppercase tracking-[0.08em] text-[#8d9db5] font-bold mb-[0.2rem]">Next →</p><p className="text-[0.93rem] font-semibold m-0"><Link href="/module-3" className="text-[#1b2537] hover:text-[#0d7c7e] hover:underline">Module 3: Financial Literacy</Link></p></div>
            </div>
          </div>
          ...
          <div>
            <div className="sticky top-[74px]">
              <div className="bg-white border border-[#dde2eb] rounded-[10px] p-[1.1rem_1.2rem] mb-4 shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
                <p className="text-[0.7rem] font-bold uppercase tracking-[0.09em] text-[#8d9db5] mb-[0.7rem]">In This Module</p>
                <ul className="list-none p-0 m-0">
                  {[["#objectives","📌 Learning Objectives"],["#lesson","📖 Lesson"],["#activity","✉️ Activity"],["#assessment","🗺 Assessment"],["#model","💡 Model Response"],["#tools","🛠 Tools"]].map(([href,label])=>(
                    <li key={href} className="border-b border-[#edf0f4] last:border-b-0"><a href={href} className="block py-[7px] text-[0.85rem] text-[#5a6a82] hover:text-[#0d7c7e] no-underline transition-colors">{label}</a></li>
                  ))}
                </ul>
              </div>
              <div className="bg-[#fef3e2] border border-[#fcd69a] border-l-[3px] border-l-[#c2680a] rounded-[10px] p-[1.1rem_1.2rem] mb-4">
                ...
                <p className="text-[0.875rem] text-[#1b2537] mb-[0.4rem]"><strong>Campus Resource Map</strong> · 75 pts</p>
                <p className="text-[0.82rem] text-[#5a6a82] mb-2">Identify 6 resources across 3 categories specific to your school.</p>
                <Link href="/assignments#a2" className="text-[0.82rem] text-[#0d7c7e] hover:underline">View full rubric →</Link>
              </div>
              <div className="bg-white border border-[#dde2eb] rounded-[10px] p-[1.1rem_1.2rem] mb-4 shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
                <p className="text-[0.7rem] font-bold uppercase tracking-[0.09em] text-[#8d9db5] mb-[0.7rem]">Course Progress</p>
                <div className="flex flex-col gap-[6px] text-[0.82rem]">
                  <div className="flex items-center gap-2 text-[#8d9db5]"><span>✓</span><Link href="/module-1" className="text-[#8d9db5] hover:underline">Module 1: College Expectations</Link></div>
                  <div className="flex items-center gap-2"><span className="text-[#0d7c7e] font-bold">●</span><span className="font-semibold text-[#1b2537]">Module 2 — Current</span></div>
                  <div className="flex items-center gap-2 text-[#8d9db5]"><span>○</span><Link href="/module-3" className="text-[#8d9db5] hover:underline">Module 3: Financial Literacy</Link></div>
                  <div className="flex items-center gap-2 text-[#8d9db5]"><span>○</span><span>Modules 4–7…</span></div>
                </div>
              </div>
            </div>
          </div>
