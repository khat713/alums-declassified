          ...
          <div>
            ...
            <div id="lesson" className="content-block p-7 mb-5" style={{ borderLeft: '3px solid #0d7c7e' }}>
              ...
              <Infographic title="The Campus Resource Map" filename="Infographic - Your Campus Resource Map.png" active={true} />
                  ...
                  "Every campus is full of help that students never use, and first-gen students use it least of all. Part of that is not knowing these resources exist, and part of it is a feeling that asking for help means you do not belong or that these services are for people worse off than you, but both of those assumptions are wrong. Almost every resource on this list is already paid for through your tuition and fees, so using it is not asking for a favor — you are collecting something you already bought.",
                  ...
                  "The counseling center handles mental health support, and there is a whole module later in this course about why that matters, so for now just know it exists, that an intake appointment is usually free or low cost, and that you do not have to be in crisis to make one. Waitlists get long around midterms, so it is worth knowing how to book an appointment before you actually need one.",
                  "The food pantry is on more campuses than students realize. More college students deal with food insecurity than most people realize, and nobody talks about it. Campus pantries are confidential and free to enrolled students without requiring proof of need. If your grocery money runs out before the month does, which happens to a lot of students, the pantry is there and you already qualify by being enrolled.",
            ...
            <div id="assessment" className="content-block p-7 mb-5" style={{ borderLeft: '3px solid #0d7c7e' }}>
              ...
              <DocumentDownload title="Module 2 Assignment" description="Download the assignment instructions and rubric." filename="Module_2_Assignment.docx" type="assessment" active={true} />
