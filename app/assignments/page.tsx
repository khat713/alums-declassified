  ...
  return (
    <main>
      ...
      <div className="container mx-auto px-4 my-8">
        {/* Overview Table */}
        <FadeIn delay={0}>
        <div className="content-block p-7 mb-8">
            ...
            <table className="w-full border-collapse text-[0.875rem]">
              <thead>
                <tr>
                  {["#", "Assignment", "Points", "Format", "Module"].map((h) => (
                    <th key={h} className="bg-[#f2f4f7] dark:bg-[#162032] text-[#5a6a82] dark:text-[#94a3b8] px-[14px] py-[10px] text-left font-semibold text-[0.75rem] uppercase tracking-[0.07em] border-b-2 border-[#dde2eb] dark:border-[#334155]">
                      {h}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {[
                  ...
                  <tr key={row.num} className="hover:bg-[#fafbfd] dark:hover:bg-[#1a2638]">
                    <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top">{row.num}</td>
                    ...
                    <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top">{row.pts}</td>
                    <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top">{row.fmt}</td>
                    <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top">
                      {row.modHref ? (
                ...
                <tr className="bg-[#f2f4f7] dark:bg-[#162032]">
          ...
          <table className="w-full border-collapse text-[0.875rem]">
            ...
            <tbody>
              <tr className="hover:bg-[#fafbfd] dark:hover:bg-[#1a2638]">
                <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top"><strong className="text-[#16723d]">Exemplary</strong></td>
                <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top">Deep engagement with the material, applied directly to your own situation, goes beyond surface-level completion.</td>
              </tr>
              <tr className="hover:bg-[#fafbfd] dark:hover:bg-[#1a2638]">
                <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top"><strong className="text-[#1a56a4]">Proficient</strong></td>
                <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top">Addresses the prompt completely and shows clear understanding. Meets the standard for course completion.</td>
              </tr>
              <tr className="hover:bg-[#fafbfd] dark:hover:bg-[#1a2638]">
                <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top"><strong className="text-[#c2680a]">Emerging</strong></td>
                <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top">Incomplete, vague, or doesn&apos;t directly engage with the module content. Revision encouraged.</td>
              </tr>
              <tr className="hover:bg-[#fafbfd] dark:hover:bg-[#1a2638]">
                <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top"><strong className="text-[#b0264a]">Incomplete</strong></td>
                <td className="px-[14px] py-[11px] border-b border-[#edf0f4] dark:border-[#243044] align-top">Missing, off-topic, or no meaningful engagement. Must be resubmitted before advancing.</td>
              </tr>
            </tbody>
          </table>
        ...
        <FadeIn delay={0}>
        <div id="a1" className="content-block p-7 mb-8" style={{ borderLeft: '3px solid #0d7c7e', borderRadius: '0 16px 16px 0' }}>
          <span className="inline-block text-[0.68rem] font-bold uppercase tracking-[0.09em] px-[9px] py-[3px] rounded-[20px] mb-3 bg-[#fde4ec] text-[#b0264a]">
            Assignment 1 · 50 pts
          </span>
          <h2 className="text-[1.1rem] font-bold text-[#1b2537] dark:text-[#e2e8f0] mb-4 pb-[0.65rem] border-b border-[#edf0f4] dark:border-[#243044] " style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.25rem,2.5vw,1.75rem)", fontWeight: 700, letterSpacing: "-0.02em", lineHeight: 1.1 }}>College Expectations Quiz</h2>
        ...
        <FadeIn delay={0.1}>
        <div id="a2" className="content-block p-7 mb-8" style={{ borderLeft: '3px solid #0d7c7e', borderRadius: '0 16px 16px 0' }}>
        ...
        <FadeIn delay={0.2}>
        <div id="a3" className="content-block p-7 mb-8" style={{ borderLeft: '3px solid #0d7c7e', borderRadius: '0 16px 16px 0' }}>
        ...
        <FadeIn delay={0.3}>
        <div id="a4" className="content-block p-7 mb-8" style={{ borderLeft: '3px solid #0d7c7e', borderRadius: '0 16px 16px 0' }}>
        ...
        <FadeIn delay={0.4}>
        <div id="a5" className="content-block p-7 mb-8" style={{ borderLeft: '3px solid #0d7c7e', borderRadius: '0 16px 16px 0' }}>
        ...
        <FadeIn delay={0.5}>
        <div id="a6" className="content-block p-7 mb-8" style={{ borderLeft: '3px solid #0d7c7e', borderRadius: '0 16px 16px 0' }}>
        ...
        <FadeIn delay={0.6}>
        <div id="a7" className="content-block p-7 mb-8" style={{ borderLeft: '3px solid #0d7c7e', borderRadius: '0 16px 16px 0' }}>
        ...
        <FadeIn delay={0.7}>
        <div id="a8" className="content-block p-7 mb-8" style={{ borderLeft: '3px solid #0d7c7e', borderRadius: '0 16px 16px 0' }}>
