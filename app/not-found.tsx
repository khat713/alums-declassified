...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-4" style={{ background: 'linear-gradient(135deg, #f2f4f7 0%, #e0f4f4 100%)' }}>
      <motion.div
      ...
      >
        ...
        <h1 style={{ fontFamily: 'Fraunces, serif', fontSize: 'clamp(1.5rem, 3vw, 2.25rem)', fontWeight: 700, color: '#1b2537', marginBottom: '0.75rem', letterSpacing: '-0.025em' }}>
          This page doesn&apos;t exist.
        </h1>
        <p style={{ color: '#5a6a82', fontSize: '1.05rem', marginBottom: '2.5rem', maxWidth: '420px', lineHeight: 1.7 }}>
