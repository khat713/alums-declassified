    ...
    <main>
      <div className="bg-white border-b border-[#dde2eb] py-[10px] text-[0.82rem]">
        <div className="container mx-auto px-4">
          ...
          <span className="text-[#8d9db5] mx-[6px]">/</span>
          <span className="text-[#1b2537] font-medium">Module 1: College Expectations</span>
        </div>
      </div>
      ...
      <section className="bg-white border-b border-[#dde2eb] py-9 pb-7">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-[clamp(1.5rem,3vw,1.95rem)] font-bold text-[#1b2537] mb-[0.4rem] tracking-[-0.025em] leading-[1.2]" style={{ fontFamily: "var(--font-display)" }}>College Expectations</h1>
          <p className="text-[#5a6a82] text-[0.97rem] max-w-[600px] m-0">The unwritten rules, syllabi, office hours, and how college really works — the things nobody tells you out loud.</p>
          <div className="flex flex-wrap gap-4 mt-4 pt-4 border-t border-[#edf0f4]">
            ...
            <span className="flex items-center gap-[5px] text-[0.82rem] text-[#5a6a82]">📝 <strong className="text-[#1b2537]">Assessment:</strong> Reflection prompt</span>
            <span className="flex items-center gap-[5px] text-[0.82rem] text-[#5a6a82]">🏆 <strong className="text-[#1b2537]">50 points</strong></span>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div>
            ...
            <div id="lesson" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>Module 1 Lesson</h2>
            ...
            <div id="activity" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>Activity: Campus Policy Scavenger Hunt</h2>
            ...
            <div id="assessment" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>Reflection: One Unwritten Rule I Didn&apos;t Know Before</h2>
            ...
            <div id="model" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <h2 className="text-[1.1rem] font-bold text-[#1b2537] mb-4 pb-[0.65rem] border-b border-[#edf0f4] tracking-[-0.015em] leading-[1.3]" style={{ fontFamily: "var(--font-display)" }}>Example Response — See What Proficient Looks Like</h2>
              <div className="bg-[#f2f4f7] border-[1.5px] border-dashed border-[#dde2eb] rounded-[5px] p-[1.4rem_1.5rem] text-[#5a6a82] text-[0.92rem] text-left">
            ...
            <div id="tools" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-[0.875rem]">
                  ...
                  <tbody>
                    <tr className="hover:bg-[#fafbfd]"><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">[Tool name]</td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">[What it&apos;s used for]</td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]"><a href="#" className="text-[#0d7c7e] hover:underline">View</a></td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">Free</td></tr>
                    <tr className="hover:bg-[#fafbfd]"><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">[Tool name]</td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">[What it&apos;s used for]</td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]"><a href="#" className="text-[#0d7c7e] hover:underline">View</a></td><td className="px-[14px] py-[11px] border-b border-[#edf0f4]">Free</td></tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-white border border-[#dde2eb] rounded-[10px] py-5 px-7 shadow-[0_1px_2px_rgba(27,37,55,0.06)] flex justify-between items-center flex-wrap gap-4 mt-2">
              <div>
                <p className="text-[0.72rem] uppercase tracking-[0.08em] text-[#8d9db5] font-bold mb-[0.2rem]">← Previous</p>
                <p className="text-[0.93rem] font-semibold text-[#1b2537] m-0"><Link href="/start-here" className="text-[#1b2537] hover:text-[#0d7c7e] hover:underline">Start Here — Syllabus</Link></p>
              </div>
              <div className="text-right">
                <p className="text-[0.72rem] uppercase tracking-[0.08em] text-[#8d9db5] font-bold mb-[0.2rem]">Next →</p>
                <p className="text-[0.93rem] font-semibold text-[#1b2537] m-0"><Link href="/module-2" className="text-[#1b2537] hover:text-[#0d7c7e] hover:underline">Module 2: Campus Resources</Link></p>
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="sticky top-[74px]">
              <div className="bg-white border border-[#dde2eb] rounded-[10px] p-[1.1rem_1.2rem] mb-4 shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
                ...
                <ul className="list-none p-0 m-0">
                  {[["#objectives","📌 Learning Objectives"],["#lesson","📖 Lesson"],["#activity","🔍 Activity"],["#assessment","✏️ Assessment"],["#model","💡 Model Response"],["#tools","🛠 Tools"]].map(([href,label])=>(
                    <li key={href} className="border-b border-[#edf0f4] last:border-b-0">
                      <a href={href} className="block py-[7px] text-[0.85rem] text-[#5a6a82] hover:text-[#0d7c7e] no-underline transition-colors">{label}</a>
                    </li>
                  ))}
                </ul>
              </div>
              <div className="bg-[#fef3e2] border border-[#fcd69a] border-l-[3px] border-l-[#c2680a] rounded-[10px] p-[1.1rem_1.2rem] mb-4">
                ...
                <p className="text-[0.875rem] text-[#1b2537] mb-[0.4rem]"><strong>Reflection Prompt</strong> · 50 pts</p>
                <p className="text-[0.82rem] text-[#5a6a82] mb-2">Complete the assessment section above, then submit via the embedded form.</p>
              ...
              <div className="bg-white border border-[#dde2eb] rounded-[10px] p-[1.1rem_1.2rem] mb-4 shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
                ...
                <div className="flex flex-col gap-[6px] text-[0.82rem]">
                  <div className="flex items-center gap-2"><span className="text-[#0d7c7e] font-bold">●</span><span className="font-semibold text-[#1b2537]">Module 1 — Current</span></div>
                  <div className="flex items-center gap-2 text-[#8d9db5]"><span>○</span><Link href="/module-2" className="text-[#8d9db5] hover:underline">Module 2: Campus Resources</Link></div>
                  ...
                  <div className="flex items-center gap-2 text-[#8d9db5]"><span>○</span><span>Module 4–7…</span></div>
                </div>
              </div>
            </div>
          </div>
