        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div>
            ...
            <div id="activity" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <p className="text-[0.85rem] text-[#8d9db5] mt-4">Keep your Cornell notes — you can use them as a model when taking notes in your actual classes this semester.</p>
            </div>
            ...
            <div id="model" className="bg-white rounded-[10px] p-7 mb-5 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
              ...
              <p className="text-[0.82rem] text-[#8d9db5] mt-2">Proficient: schedule includes all required elements, rationale names two specific strategies and explains the research behind why they work.</p>
            </div>
          ...
          <div>
            <div className="sticky top-[74px]">
              ...
              <div className="bg-[#fef3e2] rounded-[10px] p-6 mb-4 border border-[#fcd69a]">
                ...
                <p className="font-bold text-[#1b2537] text-[0.95rem] mb-1">Study Plan + Rationale · 75 pts</p>
              ...
              <div className="bg-white rounded-[10px] p-6 border border-[#dde2eb] shadow-[0_1px_2px_rgba(27,37,55,0.06)]">
                ...
                <div className="flex flex-col gap-[6px] text-[0.82rem]">
                  <div className="flex items-center gap-2 text-[#8d9db5]"><span>✓</span><span>Modules 1–4</span></div>
                  <div className="flex items-center gap-2"><span className="text-[#0d7c7e] font-bold">●</span><span className="font-semibold text-[#1b2537]">Module 5 — Current</span></div>
                  <div className="flex items-center gap-2 text-[#8d9db5]"><span>○</span><Link href="/module-6" className="text-[#8d9db5] hover:underline">Module 6: Career Prep</Link></div>
                  <div className="flex items-center gap-2 text-[#8d9db5]"><span>○</span><Link href="/module-7" className="text-[#8d9db5] hover:underline">Module 7: Emotional Resilience</Link></div>
                </div>
              </div>
            </div>
          </div>
