        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8">
          ...
          <div>
            ...
            <div id="lesson" className="content-block p-7 mb-5" style={{ borderLeft: '3px solid #0d7c7e' }}>
              ...
              <Infographic title="Study Techniques Ranked by Evidence" filename="Infographic - Study Smarter.png" active={true} />
                  ...
                  "Most first-gen students were good enough at high school to get into college, which means most of you have study habits that worked. The problem is that the habits that worked in high school are usually the ones research says do not work that well. They fail slowly enough in college that by the time you notice, you are already behind. The good news is that the techniques that actually work take less time, not more.",
                  ...
                  "Put those two together: short study sessions spread across the week where you test yourself instead of reread. It is not glamorous but it works better than cramming.",
                  ...
                  "Getting through college academically is more about method than talent. Test yourself instead of rereading, space your studying out, schedule time around your syllabus, and reach out to professors before things fall apart. You can start doing all of that this week.",
                  "References",
            ...
            <div id="model" className="content-block p-7 mb-5">
              ...
              <DocumentDownload title="Module 5 Worked Example" description="Read through this before you write your own." filename="Module_5_Model_Responses.docx" type="model" active={true} />
            </div>
            </FadeIn>
          ...
          <div>
            <div className="sticky top-[74px]">
              ...
              <LessonSelfCheck
                questions={[
            "I can describe two study or note-taking strategies that are actually backed by research",
            "I know what imposter syndrome is and can recognize it in myself",
            "I feel confident enough to build a weekly study schedule before classes start",
                ]}
